// 디딤돌대출 (내집마련 디딤돌 대출) — 금리표는 2026년 7월 확인
// 한도·자격은 주택도시기금 「내집마련디딤돌대출」 안내 원문(2026-09-06 재확인) 기준이다.
// 원문: "일반 2억원(생애최초 주택구입자 2.4억원, 신혼가구 또는 2자녀 이상 가구 3.2억원) 이내"
// — 인터넷에 흔한 2.5억/3억/4억은 '25.6.27. 이전 계약 체결 건에만 적용되는 종전 한도다.

export const STEPPING_STONE_UPDATED = "2026-07-10";
...
/** 대출 한도 — 주택도시기금 「내집마련디딤돌대출」 대출한도 (2025.6.27. 이후 계약 체결 기준) */
...
export const STEPPING_STONE_PRESETS: readonly { key: string; label: string; description: string }[] = [
  { key: "newlywed-4", label: "생애최초 신혼 4억", description: "생애최초 신혼가구, 연소득 6천만, 30년" },
...
export const STEPPING_STONE_FAQS: readonly { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "부부합산 연소득과 대출 기간에 따라 금리가 달라집니다. 일반 생애최초는 기본표에서 0.2%p 우대하고, 생애최초 신혼가구는 별도 금리표를 적용합니다. 추가 우대는 조건과 적용기간을 확인해야 합니다.",
  },
  {
    q: "디딤돌대출 최대 한도는 얼마인가요?",
    a: "일반 2억원, 생애최초 2.4억원, 생애최초 신혼가구 3.2억원이 계산기상 상품 한도이며, LTV 70%(생애최초 비수도권 80%), DTI 60% 이내여야 합니다. 2025년 6월 27일 이전에 계약을 체결한 건은 종전 한도(일반 2.5억원, 생애최초 3억원, 신혼가구·2자녀 이상 4억원)가 적용되므로 계약일을 먼저 확인해야 합니다.",
  },
  {
...
export const STEPPING_STONE_SOURCES = [
  { name: "주택도시기금", url: "https://nhuf.molit.go.kr/FP/FP05/FP0503/FP05030101.jsp", basis: "내집마련디딤돌대출 대출한도·소득요건 (2026-09-06 확인)" },
