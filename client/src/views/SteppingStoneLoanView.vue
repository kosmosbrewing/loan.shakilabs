...
import { LOAN_STEPPING_STONE_GUIDE } from "@/data/seoGuides";
...
const mergedFaqs = mergeFaqs(STEPPING_STONE_FAQS, LOAN_STEPPING_STONE_GUIDE.faqs);
...
<template>
  ...
  <div class="container space-y-5 py-5">
    ...
    <SeoRichGuide
      :title="LOAN_STEPPING_STONE_GUIDE.title"
      :intro="LOAN_STEPPING_STONE_GUIDE.intro"
      :sections="LOAN_STEPPING_STONE_GUIDE.sections"
      :disclaimer="LOAN_STEPPING_STONE_GUIDE.disclaimer"
    />
  </div>
</template>
