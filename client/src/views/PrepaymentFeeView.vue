...
import { LOAN_PREPAYMENT_GUIDE } from "@/data/seoGuides";
...
const mergedFaqs = mergeFaqs(PREPAYMENT_FEE_FAQS, LOAN_PREPAYMENT_GUIDE.faqs);
...
<template>
  ...
  <div class="container space-y-5 py-5">
    ...
    <SeoRichGuide
      :title="LOAN_PREPAYMENT_GUIDE.title"
      :intro="LOAN_PREPAYMENT_GUIDE.intro"
      :sections="LOAN_PREPAYMENT_GUIDE.sections"
      :disclaimer="LOAN_PREPAYMENT_GUIDE.disclaimer"
    />
  </div>
</template>
