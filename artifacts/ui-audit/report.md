...
| ID | 초기 심각도 | 초기 문제 | 상태 |
|---|---|---|---|
| LOAN-AUD-001 | P1 | 200% 확대에서 입력·결과·긴 가이드가 매우 좁은 열로 압축됩니다. | resolved |
| LOAN-AUD-002 | P2 | 주 탭 inactive 텍스트 대비가 2.98:1입니다. | resolved |
| LOAN-AUD-003 | P2 | 금액 입력이 주변 label과 연결되지 않아 visible unlabeled control이 반복됩니다. | resolved |
| LOAN-AUD-004 | P2 | 12px 미만 텍스트 최대 33개와 소스 tiny 패턴 16개가 확인됩니다. | resolved |

## 4. 열린 문제
전체 machine-readable 필드는 [issues.json](./issues.json)에 있습니다.

### LOAN-AUD-005 · P2
- 제품 소스 3개가 300줄 기준을 초과합니다.
- 현재: client/src/assets/css/main.css 390줄, client/src/data/seoGuides.ts 351줄, client/src/lib/validators.ts 335줄
